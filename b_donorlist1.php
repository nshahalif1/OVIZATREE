...
<!DOCTYPE html>
<html>
    <head> <title>OVIZATREE BLOOD DONOR
           </title>
	...
	<body>
	    ...
	    <form action = "b_donorlist1.php" method ="POST" >
		    <fieldset>
...
<?php 
	 ...
	 if(isset($_POST['name']) && isset($_POST['fname']) && isset($_POST['mname']) && isset($_POST['dob']) && isset($_POST['mail']) && isset($_POST['bg']) && isset($_POST['phone']) && isset($_POST['address']) && isset($_POST['profession']) ) {
		  ...
		  $sql = " INSERT INTO b_donorlist1 (Name, Fathers_Name, Mothers_Name, DOB, Mail, BG, Phone, Address, Profession ) 
